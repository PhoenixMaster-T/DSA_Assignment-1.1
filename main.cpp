...
#define expectedTest_7 "out of range"
#define expectedTest_8_0 "ok"
...
int main()
{
    ...
    exOutBound = std::out_of_range("ok");
    // UnitTest 8
    try {
        fList.add(7, -1);
    }
    ...
    //UnitTest 10
    for (FragmentLinkedList<int>::Iterator v = fList.begin(); v != fList.end(); v++) (*v) *= 2;
